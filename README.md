...
Characterizes protein-ligand interaction distributions across structure sources using the Protein-Ligand Interaction Profiler (PLIP). Includes statistical tests comparing interaction count distributions between sources. **Raw XML reports for each complex and structure generation method can be found at [10.5281/zenodo.18701481](https://doi.org/10.5281/zenodo.18701481).**  
...
Structure files and per-pose PLIP outputs are not included in this repository due to size but were generated on the MSU HPCC and are will be made publicly available upon official publication at 10.5281/zenodo.18701481.
